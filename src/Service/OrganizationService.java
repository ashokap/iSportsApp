...
public class OrganizationService {
    ...
    public Batch createNewBatch(Date startDate, Date endDate, Long trainingId, int maxParticipants, Long trainierId,
                                double basePrice, Date effectiveDateOfPrice){
        Batch newBatch = new Batch(startDate, endDate, trainingId, maxParticipants, trainierId);
        TrainingPricing newPricing = new TrainingPricing(basePrice, effectiveDateOfPrice, newBatch.getBatchNumber());
    ...
    public Batch updateNewBatch(Date startDate, Date endDate, Long batchId, int maxParticipants, Long trainerId){

        //Get batch from batchId
        Batch newBatch = new Batch(startDate, endDate, 1234L, maxParticipants, trainerId);
        return newBatch;
    }
